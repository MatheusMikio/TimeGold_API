...
func ProfessionalRequestMagicLink(service services.IAuthProfessionalService) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		handlers.SendSuccess(ctx, http.StatusOK, "ProfessionalRequestMagicLink", "Magic link sent to your email")
	}
}

func ProfessionalVerifyMagicLink(service services.IAuthProfessionalService) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		response, errMsg := service.VerifyMagicLink(token)
		if errMsg != nil {
